...
FlowRouter.route('/admin/weixin/user', {
   name: 'weixinUser',
    action() {
        BlazeLayout.render('AdminLayout', {main: 'bindingPage'});
    }
});

FlowRouter.route('/admin/weixin/program', {
   name: 'programSelector',
    action() {
        BlazeLayout.render('AdminLayout', {main: 'programSelector'});
    }
});
